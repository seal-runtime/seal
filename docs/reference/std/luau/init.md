...
Autogenerated from [std/luau/init.luau](/.seal/typedefs/std/luau/init.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
