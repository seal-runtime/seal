...
Autogenerated from [std/io/prompt.luau](/.seal/typedefs/std/io/prompt.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
