...
Autogenerated from [std/io/format.luau](/.seal/typedefs/std/io/format.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
