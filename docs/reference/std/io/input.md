...
Autogenerated from [std/io/input.luau](/.seal/typedefs/std/io/input.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
