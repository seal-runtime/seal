...
Autogenerated from [std/net/http/init.luau](/.seal/typedefs/std/net/http/init.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
