...
Autogenerated from [std/net/http/server.luau](/.seal/typedefs/std/net/http/server.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
