...
Autogenerated from [std/crypt/hash.luau](/.seal/typedefs/std/crypt/hash.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
