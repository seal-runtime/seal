...
Autogenerated from [std/serde/toml.luau](/.seal/typedefs/std/serde/toml.luau). *seal* is best experienced with inline, in-editor documentation. Please see the linked typedefs file if this documentation is confusing, too verbose, or inaccurate.
