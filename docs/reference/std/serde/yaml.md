...
Autogenerated from [std/serde/yaml.luau](/.seal/typedefs/std/serde/yaml.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
