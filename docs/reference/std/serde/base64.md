...
Autogenerated from [std/serde/base64.luau](/.seal/typedefs/std/serde/base64.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
