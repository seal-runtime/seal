...
Autogenerated from [std/time/datetime.luau](/.seal/typedefs/std/time/datetime.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
