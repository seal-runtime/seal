...
Autogenerated from [std/time/init.luau](/.seal/typedefs/std/time/init.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
