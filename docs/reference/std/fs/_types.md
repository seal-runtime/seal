...
Autogenerated from [std/fs/_types.luau](/.seal/typedefs/std/fs/_types.luau).Please see that file if this documentation is confusing, inaccurate, or too verbose.
