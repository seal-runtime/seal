...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$local dir = fs.tree()
$hspace{5pt}$    :with_tree("subtree", fs.tree()
$hspace{5pt}$        :with_file("hi.json", '{"hi"}: true')
$hspace{5pt}$    )
$hspace{5pt}$```
...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$local csv = fs.file("./mybigdata.csv")
$hspace{5pt}$if csv then
$hspace{5pt}$    for line_number, line in csv:readlines() do
$hspace{5pt}$        print(line)
$hspace{5pt}$    end
$hspace{5pt}$end
$hspace{5pt}$```
$hspace{5pt}$
...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$local src = fs.dir.ensure("./src")
$hspace{5pt}$    :add_file("main.luau", 'print("hi")')
$hspace{5pt}$    :add_file("byte.luau", 'print("munch")')
$hspace{5pt}$```
$hspace{5pt}$
$hspace{5pt}$## Errors
...
$hspace{5pt}$```luau
$hspace{5pt}$local src = fs.dir.ensure("./src")
$hspace{5pt}$    :add_tree("libraries", fs.tree()
$hspace{5pt}$        :with_file("Lists.luau", lists_src)
$hspace{5pt}$    )
$hspace{5pt}$```
$hspace{5pt}$
$hspace{5pt}$## Errors
...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$if current_dir:find(".luaurc"):exists() then
$hspace{5pt}$    luaurc_path = path.join(current_dir.path, ".luaurc")
$hspace{5pt}$end
$hspace{5pt}$```
$hspace{5pt}$
$hspace{5pt}$## Errors
...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$local main_luau = fs.find("./src/main.luau"):try_file()
$hspace{5pt}$if main_luau then
$hspace{5pt}$    process.shell(`seal {main_luau.path}`):unwrap()
$hspace{5pt}$end
$hspace{5pt}$```
...
$hspace{5pt}$## Usage
$hspace{5pt}$```luau
$hspace{5pt}$local src = fs.find("./src"):try_dir()
$hspace{5pt}$if src then
$hspace{5pt}$    print(src:list(--[[recursive = ]] true))
$hspace{5pt}$end
$hspace{5pt}$```
