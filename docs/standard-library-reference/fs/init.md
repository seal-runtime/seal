...
`WatchKind.-- Execute -- AccessKind::Open(Execute)`

`WatchKind.| "Open::Execute"`

`WatchKind.-- Open -- AccessKind::Open(_)`
...
`WatchKind.-- Close -- AccessKind::Close(_)`
...
`WatchKind.-- Access -- AccessKind::Any, AccessKind::Open(Any), AccessKind::Other`
...
`WatchKind.-- Rename -- ModifyKind::Name`
...
`WatchKind.-- Modify::Data -- ModifyKind::Data`
...
`WatchKind.-- Modify::Metadata -- ModifyKind::Metadata`
...
`WatchKind.-- Modify::Other -- ModifyKind::Any, ModifyKind::Other`

`WatchKind.| "Modify::Any"`

`WatchKind.| "Modify::Other"`

`WatchKind.-- Remove -- RemoveKind`
...
`WatchKind.-- Other -- EventKind::Other`

`WatchKind.| "Other"`

`WatchKind.-- Unknown -- EventKind::Any`
