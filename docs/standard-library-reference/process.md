...
`function ChildProcess.run(options: RunOptions): RunResult`
...
`function ChildProcess.shell(command: string): RunResult`
...
`function ChildProcess.spawn(options: SpawnOptions): ChildProcess`
